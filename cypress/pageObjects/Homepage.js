export class Homepage
{
    ...
    hoverOnEyeCareMenu()
    {
        cy.get('.dropdown a[href="https://dev.ezcontacts.com/eye-care"]').should('have.text','Eye Care').trigger('mouseover')
    }
    validateEyecareMenu()
    {
    ...
    {
        cy.get('[href="https://dev.ezcontacts.com/online-vision-test/"]').should('exist').click() //validate and click HOWS YOUR Vision?
        cy.wait(2000)
