export class MenuOptions
{
    ...
    goToEyecareCatalog()
    {
        cy.get('.dropdown [href="https://dev.ezcontacts.com/eye-care"]').should('contain.text','Eye Care').click() //EYE CARE Menu
    ...
    {
        cy.get('.dropdown [href="https://dev.ezcontacts.com/eye-care"]').should('contain.text','Eye Care') //EYE-CARE Menu
